...
| **4. The Query Master** | Amayo Torres Juan Antonio y Bañuelos Sandoval Aleri| Pobla la base de datos (datos semilla) y extrae reportes de inteligencia de negocios. | `02_seed.sql`, `queries/*.sql` |
